...
namespace NoiseGenerator
{
    public class NoiseGeneratorEditor : EditorWindow
    {
        ...
        private ComputeShader _ditherNoiseShader;
        ...
        private NoiseType[] _selectNoise = new NoiseType[5]
        {
            NoiseType.ValueNoise, NoiseType.ValueNoise,
            NoiseType.ValueNoise, NoiseType.ValueNoise,
            NoiseType.ValueNoise
        };
        ...
        {
            _valueNoiseShader =
                AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/Editor/NoiseGenerator/ValueNoise.compute");
            _ditherNoiseShader =
                AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/Editor/NoiseGenerator/DitherNoise.compute");
            _perlinNoiseShader =
                AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/Editor/NoiseGenerator/PerlinNoise.compute");
            _simplexNoiseShader =
                AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/Editor/NoiseGenerator/SimplexNoise.compute");
            _worleyNoiseShader =
                AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/Editor/NoiseGenerator/WorleyNoise.compute");
            _worleyPerlinNoiseShader =
                AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/Editor/NoiseGenerator/Worley_PerlinNoise.compute");

            _perlinNoise3DShader =
                AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/Editor/NoiseGenerator/PerlinNoise3D.compute");
            _worleyNoise3DShader =
                AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/Editor/NoiseGenerator/WorleyNoise3D.compute");
            _worleyPerlinNoise3DShader =
                AssetDatabase.LoadAssetAtPath<ComputeShader>(
                    "Assets/Editor/NoiseGenerator/Worley_PerlinNoise3D.compute");
        }
        ...
        private void OnGUI()
        {
            ...
            if (_selectMode == 0)
            {
                ...
                _selectNoise[ChanelIndex] =
                    (NoiseType)EditorGUILayout.EnumPopup("Noise Type", _selectNoise[ChanelIndex]);
                ...
                {
                    GUILayout.Box(_perview2DImage[ChanelIndex],
                        new[]
                        {
                            GUILayout.Height(_perview2DImage[ChanelIndex].height),
                            GUILayout.Width(_perview2DImage[ChanelIndex].width)
                        });
                }
                ...
                {
                    _savePath = "";
                    _savePath = EditorUtility.SaveFilePanel("保存贴图", Application.dataPath, "noise", "tga");
                    if (_savePath != "")
                    {
                        SaveNoise2D();
                    }
            ...
            if (_selectMode == 1)
            {
                ...
                _noiseScale[ChanelIndex] = EditorGUILayout.Slider("Noise Scale", _noiseScale[ChanelIndex], 1, 10);
                _select3DNoise[ChanelIndex] =
                    (Noise3DType)EditorGUILayout.EnumPopup("Noise Type", _select3DNoise[ChanelIndex]);
                _selectFbm[ChanelIndex] = (FbmType)EditorGUILayout.EnumPopup("FBM Type", _selectFbm[ChanelIndex]);
                if (_selectFbm[ChanelIndex] != FbmType.dontuse)
                {
                    EditorGUI.indentLevel++;
                ...
                {
                    GUILayout.Box(_perview3DImage[ChanelIndex],
                        new[]
                        {
                            GUILayout.Height(_perview3DImage[ChanelIndex].height),
                            GUILayout.Width(_perview3DImage[ChanelIndex].width)
                        });
                }
        ...
        float[] Get2DNoiseValue(int chanel)
        {
            ...
            {
                case NoiseType.DitherNoise:
                    shader = _ditherNoiseShader;
                    break;
        ...
        void SaveNoise2D()
        {
            ...
            tex.Apply();
            File.WriteAllBytes(_savePath, tex.EncodeToTGA());
